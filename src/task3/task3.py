...
def parse_files(plasma_file, specimen_file):
	...
	df_prev_days = df_prev_days.drop_duplicates(subset=['specimen_id', 'tpm'])
...
df_reshaped_2022['task3.1'] = Y_pred
df_reshaped_2022 = df_reshaped_2022.sort_values('task3.1', ascending=False)
df_reshaped_2022['task3.1'].to_csv('output/task/task3.1_predictions.csv')
