...
# Fold change
df['Monocytes+1day'] = df['Monocytes+1day']/df['Monocytes+0day']
...
df_reshaped_2022['task2.2'] = Y_pred
df_reshaped_2022 = df_reshaped_2022.sort_values('task2.2', ascending=False)
print(df_reshaped_2022)

df_reshaped_2022['task2.2'].to_csv('output/task/task2.2_predictions.csv')