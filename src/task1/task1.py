...
df_reshaped_2022['task1.1'] = Y_pred
df_reshaped_2022 = df_reshaped_2022.sort_values('task1.1', ascending=False)
print(df_reshaped_2022)

df_reshaped_2022['task1.1'].to_csv('output/task/task1.1_predictions.csv')
